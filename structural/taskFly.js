var Task = function (data) {
    ...
    (data.project, data.priority, data.user, data.completed);
    // this.name = data.name;
...
var initialMemoty = process.memoryUsage().heapUsed;
...
console.log('used memory ' + (afterMemory - initialMemoty)/1000000);
